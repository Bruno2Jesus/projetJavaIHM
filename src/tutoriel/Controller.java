...
public class Controller implements Initializable{
	...
	private static final EventType KeyPressed = null;
	...
	public void initialize(URL location, ResourceBundle ressources) {
        ...
        // Create scene
        SubScene subscene = new SubScene(root3D,482,398 ,true, SceneAntialiasing.BALANCED);
      ...
      //ici on récupere ce qui est écrit dans la barre de recherche quand il appuie sur entrer
        ...
        readJsonFromUrl("https://api.obis.org/v3/occurrence/grid/3?scientificname=Delphinidae");
...
//      int i =0;
//      float d = 8;
//      for(float lat = -90; lat < 90; lat += d) {
//        for(float lon = -180; lon < 180; lon += d) {
//      	  i++;
//      	  if(i%2==0) {
//      		  final PhongMaterial redMaterial = new PhongMaterial();
//                redMaterial.setDiffuseColor(new Color(0,0,0,0));
//                redMaterial.setSpecularColor(Color.RED); 
//                Point3D p1 = geoCoordTo3dCoord(lat + d, lon + d, (float)1.02);
//                Point3D p2 = geoCoordTo3dCoord(lat + 0, lon + d, (float)1.02);
//                Point3D p3 = geoCoordTo3dCoord(lat + 0, lon + 0, (float)1.02);
//                Point3D p4 = geoCoordTo3dCoord(lat + d, lon + 0, (float)1.02);
//                AddQuadrilateral(earth, p1, p2, p3, p4, redMaterial);
//      	  }else {
//      		  final PhongMaterial redMaterial = new PhongMaterial();
//                redMaterial.setDiffuseColor(new Color(0,0,0,0));
